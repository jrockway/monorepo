...
import (
	...
	"github.com/jrockway/monorepo/jlog/pkg/parse/internal/fuzzsupport"
)
...
func parseCorpusValue(line []byte) (any, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "ParseExprFrom")
	}
	...
	case "byte", "rune":
		...
		if err != nil {
			return nil, errors.Wrap(err, "UnquoteChar")
		}
		if typ == "rune" {
			return code, nil
		}
	...
	case "float64":
		...
		if err != nil {
			return float64(0), errors.Wrap(err, "ParseFloat")
		}
		return f, nil
	default:
		return nil, fmt.Errorf("expected []byte or primitive type")
