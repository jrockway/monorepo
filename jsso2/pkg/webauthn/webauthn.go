...
// FinishEnrollment verifies the authenticator response generated by the client.  Because we use a
// slightly different RPC format than Duo's webauthn library, we do the non-crypto things here, and
// delegate to that library to verify signations.  The steps below are from:
